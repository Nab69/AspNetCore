...
namespace Microsoft.AspNetCore.Builder
{
    ...
    public static class ControllerEndpointRouteBuilderExtensions
    {
        ...
        /// requests for non-filenames with a very low priority. The request will be routed to a controller endpoint that
        ...
        /// <remarks>
        /// <para>
        /// <see cref="MapFallbackToAreaController(IEndpointRouteBuilder, string, string, string, string)"/> is intended to handle cases where URL path of
        /// the request does not contain a filename, and no other endpoint has matched. This is convenient for routing
        /// requests for dynamic content to a SPA framework, while also allowing requests for non-existent files to
        /// result in an HTTP 404.
        /// </para>
