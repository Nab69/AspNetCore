...
namespace Microsoft.AspNetCore.Mvc.Infrastructure
{
    ...
    //
    // The ActionSelectionTablee stores a mapping of route-values -> items for each known set of
    ...
    internal class ActionSelectionTable<TItem>
    {
        ...
        public Dictionary<string[], List<TItem>> OrdinalEntries { get; }

        public Dictionary<string[], List<TItem>> OrdinalIgnoreCaseEntries { get; }
        ...
        public static ActionSelectionTable<RouteEndpoint> Create(IReadOnlyList<Endpoint> endpoints)
        {
