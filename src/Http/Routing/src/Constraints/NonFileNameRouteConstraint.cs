...
{
    /// <summary>
    /// Constrains a route parameter to represent only non-filename values.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This constraint can be used with a low priority route to disambiguate for requests for
    /// dynamic content versus static files served from the application.
    /// </para>
    /// <para>
    ...
    /// must contain the <c>.</c> character surrounded by characters on both sides. If the segment
    /// contains multiple <c>.</c>characters, then the last one will be considered.
    /// </para>
    /// <para>
    ...
    ///     <item>  
    ///         <term><c>/a/b/.c</c></term>  
    ///         <description>Final segment contains a <c>.</c> but is not surrounded by other characters.</description>  
    ///     </item>
    ///     <item>  
    ///         <term><c></c></term>  
    ...
    ///         <description>Final segment contains a <c>.</c> surrounded by other characters.</description>  
    ///     </item>
    ///     <item>  
    ...
    public class NonFileNameRouteConstraint : IRouteConstraint
    {
            ...
            RouteDirection routeDirection)
        {
            ...
            // things that look like filenames. There's nothing here that looks like a filename, so
            // let it through.
            return true;
        }
    }
